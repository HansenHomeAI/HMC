...
assert.match(source, /maxDistance: 1\.5,/, "HMC orbit max distance should be 1.5 units.");
...
assert.doesNotMatch(source, /maxRadiusFromOrigin: 1\.5\b/, "The 1.5-unit zoom limit should not be implemented as a world-origin radius clamp.");
